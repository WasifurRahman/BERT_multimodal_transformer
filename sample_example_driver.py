...
#sys.path.insert(1,'/home/echowdh2/Research_work/general_purpose_code/downloaded_softwares/boto3')
#sys.path.insert(2,'/home/echowdh2/Research_work/general_purpose_code/downloaded_softwares/botocore')
#sys.path.insert(3,'/home/echowdh2/Research_work/general_purpose_code/downloaded_softwares/jmespath.py')
import numpy as np
import torch
...
main_ex = Experiment('bert_multimodal_transformer')
from sacred.observers import MongoObserver
from global_configs import *
url_database = conf_url_database
mongo_database_name = conf_mongo_database_name
main_ex.observers.append(MongoObserver.create(url= url_database ,db_name= mongo_database_name))
