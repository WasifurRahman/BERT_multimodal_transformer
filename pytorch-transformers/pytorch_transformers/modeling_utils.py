...
class PreTrainedModel(nn.Module):
    ...
    @classmethod
    def multimodal_from_pretrained(cls, pretrained_model_name_or_path, newly_added_config=None, *model_args, **kwargs):
        r"""Instantiate a pretrained pytorch model from a pre-trained model configuration.
        ...
        # Instantiate model.
        model = cls(config,newly_added_config, *model_args, **kwargs)
