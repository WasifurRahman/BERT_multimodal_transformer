...
class MultimodalBertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, visual, acoustic, token_type_ids=None, attention_mask=None, position_ids=None, head_mask=None):
        if attention_mask is None:
            attention_mask = torch.ones_like(input_ids)
        if token_type_ids is None:
            token_type_ids = torch.zeros_like(input_ids)
...
class MultimodalBertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, visual, acoustic, token_type_ids=None, attention_mask=None, labels=None,
                position_ids=None, head_mask=None):
        outputs = self.bert(input_ids, visual, acoustic, position_ids=position_ids, token_type_ids=token_type_ids,
                            attention_mask=attention_mask, head_mask=head_mask)
        pooled_output = outputs[1]
        pooled_output = self.dropout(pooled_output)
...
class ETSBertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, visual, acoustic, input_ids, token_type_ids=None, attention_mask=None, labels=None,
                position_ids=None, head_mask=None):
